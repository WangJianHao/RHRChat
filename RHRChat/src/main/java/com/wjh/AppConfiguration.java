    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.wjh");
                servletContext.setInitParameter("tapestry.development-modules", "com.wjh.service.DevelopmentModule");
                servletContext.setInitParameter("tapestry.qa-modules", "com.foo.service.QaModule");
